...
- Surgical mask: [Different from FFR](https://www.cdc.gov/niosh/npptl/pdfs/UnderstandingDifference3-508.pdf), a surgical mask does NOT provide the wearer with a reliable level of protection from inhaling smaller airborne particles and is not considered [respiratory protection](https://smartairfilters.com/en/blog/n95-mask-surgical-prevent-transmission-coronavirus). A surgical mask will, however, lessen the risk of you spreading the virus to others, if you are infected.
...
There is quite a [variety of PPE](https://www.cdc.gov/niosh/npptl/RespiratorInfographics.html) (personal protective equipment), mostly used by medical workers.  With an inferior solution being favorable over no solution, there is evidence that a do-it-yourself (DIY) homemade [mask made from a cotton T-shirt or tea cloth is more effective than having no mask](https://smartairfilters.com/en/blog/diy-homemade-mask-protect-virus-coronavirus).
...
Disposable masks are not meant to be [re-used](https://www.cdc.gov/niosh/topics/hcwcontrols/recommendedguidanceextuse.html). There aren't enough masks (yet) for there to be enough for everyone to use nonetheless enough for each person using one to dispose of afterward.  And chemically sanitizing the resporator masks could lessen significantly their effectiveness, as described in this [commentary from Stanford](https://stanfordmedicine.app.box.com/v/covid19-PPE-1-2). A method to cope, by those in the affected areas, has been to heat the mask to 158 degrees farhenheit (or 70 degrees celcius), for 30 minutes or more, which will likely kill this virus, presuming it [behaves the same as another coronavirus](https://europepmc.org/article/med/14631830).  Alternatively, nine or so days might be enough [time to leave a mask sit, before wearing it again](https://twitter.com/chrismartenson/status/1233402248052510720) -- as any virus on the mask (and most bacteria) would likely have died by then.  [TODO: The masks with a plastic exhilation valve will melt or otherwise will render the mask ineffective, at some temperature. Not sure if they can be disinfected with heat and yet remain usable.]  Ultraviolet Germicidal Irradiation [(UVGI) can be effective](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4699414). Also, see the [bulletin from 3M](https://multimedia.3m.com/mws/media/1816576O/disinfection-of-disposable-respirators-technical-bulletin.pdf).

**Supplies**

Plan for having enough for what, ... maybe three weeks, or two months even?  All of these supply recommendations can be used at a later time, so even if they are not needed for this specific event, the money won't have been wasted.
...
- Toilet tissue (In much of the world, this is a desparately needed commodity that the markets run out of first)
- Garbage bags
...
- Bottled water, [for various reasons](https://twitter.com/aetiology/status/1233427492742012928).  Maybe some 5 gallon jugs as well, though individual sized bottled water lessens contamination from multiple openings / closings of caps.  Individual bottles are especially useful should a member of the home fall ill, as the possibly contaminated empty bottle can then be discarded.
- Canned and frozen food, including possibly the box milk that doesn't need refrigeration before opening.  Also dried fruits and nuts. [Recommendations for those with young kids](https://twitter.com/papers_pleas/status/1231976104480649217).  Perhaps plan for several weeks before your next visit to the market, which may or may not have supplies once you eventually can make that trip.
- Batteries: You might be using your TV remote, computer mouse, and other battery-powered electronics more than normal, and you don't want to go out (or send out for delivery) just for batteries.
...
- Books / games / etc.  If you are cooped up at home for weeks, you might go nuts relying on Netflix and Facebook to pass the time.
- Whistle / bell / noisemaker.  If someone is ill in your home and isolated to a room (e.g., sent home from hospital because there's no more beds available), that person may benefit from having a bell, whisle or other noisemaker to signal the need for assistance.
- HEPA filter, Humidifier: HEPA filters can help to "clean" the air in a room.  Humidifiers may help lessen the duration that a [virus will last on a surface and infect others](https://en.wikipedia.org/wiki/Fomite).  Humidity levels from 40% to 60% are [recommended](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3551767).
...
- If you can find the travel-size Lysol spray, that might be useful if you are out (e.g., to spray on shopping cart handles, then wipe with a napkin or paper towel that you then discard).
